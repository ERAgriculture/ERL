---
title: "Evidence for Resilient Livestock: Data Exploration"
author:
  - name: "Namita Joshi"
...
pacman::p_load(
  ...
  s3fs, arrow, devtools, gh, htmlwidgets,remotes
)
...
server <- function(input, output, session) {
  output$livestockMap <- renderPlot({
    ...
    ggplot() +
      ...
      annotate("text", x = 40, y = -30, label = "One Point = One Paper", color = "#000000", size = 5, hjust = 0) +

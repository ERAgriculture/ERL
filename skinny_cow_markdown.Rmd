...
**4. Feed Intake and Weight Gain Analysis**

*4.1 Merging Feed Intake and Weight Gain Data: Merges data sets on feed intake and weight gain to analyze their relationship for specific livestock (e.g., cattle, sheep, goats)*

*4.2 Identifying Outliers: Uses the Interquartile Range (IQR) method to identify and remove outliers in weight gain data.*
...
```{rpresenting the remaining papers based on sub papers, message=F, echo=F}
  # Substitution
...
```{r feed intake and weight gain, echo=TRUE}
...
```{r adding nutrition, echo=TRUE}
intake_WG <- intake_WG %>%
  rename(`Intake item`= ED.Intake.Item)

...
animal_data_no_outliers <- filter_and_remove_outliers(WG)

# Create individual plots for each animal without outliers
plot_cattle <- ggplot(animal_data_no_outliers[animal_data_no_outliers$P.Product == "Cattle", ], aes(x = P.Product, y = `Weight Gain_kg`)) +
  geom_boxplot() +
  labs(
    x = "Animal Type",
...
plot_goat <- ggplot(animal_data_no_outliers[animal_data_no_outliers$P.Product == "Goat", ], aes(x = P.Product, y = `Weight Gain_kg`)) +
  geom_boxplot() +
  labs(
    x = "Animal Type",
    y = "Weight Gain (kg/day)"
...
plot_sheep <- ggplot(animal_data_no_outliers[animal_data_no_outliers$P.Product == "Sheep", ], aes(x = P.Product, y = `Weight Gain_kg`)) +
  geom_boxplot() +
  labs(
    x = "Animal Type",
    y = "Weight Gain (kg/day)"

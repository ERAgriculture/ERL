---
title: "Evidence for Resilient Livestock: Update of 2024_2025 Livestock Extraction"
author: 
 - name: "Namita Joshi"
...
0.  **Setting Up the Workspace Loading Required Packages**: The script uses the pacman package to load data.table for data manipulation and openalexR for accessing the OpenAlex API.
...
# GitHub raw URL for the repository
github_url <- "https://github.com/ERAgriculture/livestock_diet/raw/main/data"

# Define the data directory to store the downloaded files
search_data_dir <- "livestock_data"
...
An import script was developed in ingest the high number of excels that were used to extract information from livestock publications.
